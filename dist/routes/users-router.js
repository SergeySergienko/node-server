...
const getUsersRouter = () => {
    ...
    router.put('/', (0, middlewares_1.authMiddleware)(['OWNER']), validators_1.updateUserValidator, middlewares_1.getValidationResult, users_controller_1.default.updateUser);
