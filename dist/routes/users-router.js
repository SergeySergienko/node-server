...
const getUsersRouter = () => {
    ...
    router.put('/:id', (0, middlewares_1.authMiddleware)(['OWNER']), validators_1.updateUserValidator, middlewares_1.getValidationResult, middlewares_1.checkUserUpdateMiddleware, users_controller_1.default.updateUser);
